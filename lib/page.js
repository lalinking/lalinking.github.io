...
Object.defineProperty(window, "utils", {
    value: {
        ...
        // d: (() => {
        //     if (location.hostname !== "localhost") window['setInt\x65\x72\x76\x61\x6c'](() => {
        //         new Function("\x64\x65\x62\x75gger")()
        //     }, 300);
        // })(),
        /**
         * 创建页面元素
         ...
         * 获取当前元素计算后的样式
         */
        getComputedStyle: window.getComputedStyle ? dom => {
